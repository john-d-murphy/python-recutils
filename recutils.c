...
typedef struct {
    PyObject_HEAD rec_db_t rdb;
} recdb;

typedef struct {
    PyObject_HEAD rec_rset_t rst;
} rset;

typedef struct {
    PyObject_HEAD rec_record_t rcd;
} record;

typedef struct {
    PyObject_HEAD rec_field_t fld;
} field;

typedef struct {
    PyObject_HEAD rec_sex_t sx;
} sex;

typedef struct {
    PyObject_HEAD rec_fex_t fx;
} fex;

typedef struct {
    PyObject_HEAD rec_fex_elem_t fxel;
} fexelem;

typedef struct {
    PyObject_HEAD rec_comment_t cmnt;
} comment;

typedef struct {
    PyObject_HEAD rec_buf_t buf;
} buffer;
...
static PyObject* recdb_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    recdb* self;
...
static void recdb_dealloc(recdb* self) {
    self->ob_type->tp_free((PyObject*) self);
}

/* Return the number of record sets contained in a given database  */
static PyObject* recdb_size(recdb* self) {
...
static PyObject* recdb_pyloadfile(recdb* self, PyObject* args, PyObject* kwds) {
    char* string = NULL;
    bool success;
    rec_parser_t parser;
...
static PyObject* recdb_pyappendfile(recdb* self, PyObject* args,
                                    PyObject* kwds) {
    char* string = NULL;
    bool success = true;
    char str[100];
    ...
    while (rec_parse_rset(parser, &res)) {
        ...
        if (rec_db_type_p(self->rdb, rset_type)) {
            sprintf(str, "Duplicated record set '%s' from %s.", rset_type,
                    string);
...
static PyObject* recdb_pywritefile(recdb* self, PyObject* args,
                                   PyObject* kwds) {
    char* string = NULL;
    bool success;
    static char* kwlist[] = {"filename", NULL};
...
static PyObject* recdb_get_rset(recdb* self, PyObject* args, PyObject* kwds) {
    int pos;
    rec_rset_t res;
    PyObject* result;
...
static PyObject* recdb_pyinsert_rset(recdb* self, PyObject* args,
                                     PyObject* kwds) {
    rset* recset;
    size_t position;
    bool success;
    static char* kwlist[] = {"recset", "position", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "Oi", kwlist, &recset,
                                     &position)) {
        return NULL;
    }
...
static PyObject* recdb_pyremove_rset(recdb* self, PyObject* args,
                                     PyObject* kwds) {
    size_t position;
    bool success;
    static char* kwlist[] = {"position", NULL};
...
static PyObject* recdb_type(recdb* self, PyObject* args) {
    char* type;
...
static PyObject* recdb_get_rset_by_type(recdb* self, PyObject* args,
                                        PyObject* kwds) {
    char* type = NULL;
    rec_rset_t res;
    PyObject* result;
...
static PyObject* recdb_query(recdb* self, PyObject* args, PyObject* kwds) {
    const char* type;
    const char* join;
    size_t* index;
    sex* sexp;
    ...
    static char* kwlist[] = {"type",        "join",    "index", "sexp",
                             "fast_string", "random",  "fexp",  "password",
                             "group_by",    "sort_by", "flags", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "zzzOziOzOOi", kwlist, &type,
                                     &join, &index, &sexp, &fast_string,
    ...
    if ((PyObject*) sort_by == Py_None)
        sort_by->fx = NULL;
    res = rec_db_query(self->rdb, type, join, index, sexp->sx, fast_string,
                       random, fexp->fx, password, group_by->fx, sort_by->fx,
                       flags);
    tmp->rst = res;
...
static PyObject* recdb_insert(recdb* self, PyObject* args, PyObject* kwds) {
    ...
    static char* kwlist[] = {"type",        "index",  "sexp",
                             "fast_string", "random", "password",
                             "recp",        "flags",  NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "zzOzizOi", kwlist, &type,
                                     &index, &sexp, &fast_string, &random,
                                     &password, &recp, &flags))
    ...
    if ((PyObject*) sexp == Py_None)
        sexp->sx = NULL;
    success = rec_db_insert(self->rdb, type, index, sexp->sx, fast_string,
                            random, password, recp->rcd, flags);
    return Py_BuildValue("i", success);
}
...
static PyObject* recdb_delete(recdb* self, PyObject* args, PyObject* kwds) {
    ...
    int flags;
    bool success;
    static char* kwlist[] = {"type",   "index", "sexp", "fast_string",
                             "random", "flags", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "zzOzii", kwlist, &type,
                                     &index, &sexp, &fast_string, &random,
                                     &flags))
    ...
    if ((PyObject*) sexp == Py_None)
        sexp->sx = NULL;
    success = rec_db_delete(self->rdb, type, index, sexp->sx, fast_string,
                            random, flags);
    return Py_BuildValue("i", success);
}
...
static PyObject* recdb_set(recdb* self, PyObject* args, PyObject* kwds) {
    ...
    bool success;
    static char* kwlist[] = {"type",   "index", "sexp",   "fast_string",
                             "random", "fexp",  "action", "action_arg",
                             "flags",  NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "zzOziOizi", kwlist, &type,
                                     &index, &sexp, &fast_string, &random,
                                     &fexp, &action, &action_arg, &flags))
    ...
    if ((PyObject*) fexp == Py_None)
        fexp->fx = NULL;
    success = rec_db_set(self->rdb, type, index, sexp->sx, fast_string, random,
...
static PyObject* recdb_int_check(recdb* self, PyObject* args, PyObject* kwds) {

    bool check_descriptors_p;
    bool remote_descriptors_p;
    buffer* errors;
    int num;
    static char* kwlist[] = {"check_descriptors_p", "remote_descriptors_p",
                             "errors", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "iiO", kwlist,
                                     &check_descriptors_p,
                                     &remote_descriptors_p, &errors))
    ...
    num = rec_int_check_db(self->rdb, check_descriptors_p, remote_descriptors_p,
                           errors->buf);
...
static PyMethodDef recdb_methods[] = {
    ...
    {"pyloadfile", (PyCFunction) recdb_pyloadfile, METH_VARARGS,
     "Load data from file into DB"},
    {"pywritefile", (PyCFunction) recdb_pywritefile, METH_VARARGS,
     "Write data from DB to file"},
    {"pyappendfile", (PyCFunction) recdb_pyappendfile, METH_VARARGS,
     "Append data from DB to file"},
    {"get_rset", (PyCFunction) recdb_get_rset, METH_VARARGS,
     "Get rset by position"},
    {"pyinsert_rset", (PyCFunction) recdb_pyinsert_rset, METH_VARARGS,
     "Insert rset into DB"},
    {"pyremove_rset", (PyCFunction) recdb_pyremove_rset, METH_VARARGS,
     "Remove rset from DB"},
    {"type", (PyCFunction) recdb_type, METH_VARARGS,
     "Determine if the rset of type TYPE exists"},
    {"get_rset_by_type", (PyCFunction) recdb_get_rset_by_type, METH_VARARGS,
     "Get rset by type"},
    {"query", (PyCFunction) recdb_query, METH_VARARGS, "Query the DB"},
    {"insert", (PyCFunction) recdb_insert, METH_VARARGS,
     "Insert a record into DB"},
    {"delete", (PyCFunction) recdb_delete, METH_VARARGS,
     "Delete a record from DB"},
    {"set", (PyCFunction) recdb_set, METH_VARARGS, "Manipulate a record in DB"},
    {"int_check", (PyCFunction) recdb_int_check, METH_VARARGS,
...
static PyObject* rset_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    rset* self;
...
static void rset_dealloc(rset* self) {
...
static PyObject* rset_num_records(rset* self) {
...
static PyObject* rset_descriptor(rset* self) {
    PyObject* result;
    rec_record_t reco;
...
static PyObject* rset_type(rset* self) {
    PyObject* result;
    char* restype;
...
static PyObject* record_new(PyTypeObject* type, PyObject* args,
                            PyObject* kwds) {
    record* self;
...
static PyObject* record_num_fields(record* self) {
...
static PyObject* record_contains_value(record* self, PyObject* args,
                                       PyObject* kwds) {
    const char* value = NULL;
    bool case_insensitive;
    bool success;
    static char* kwlist[] = {"value", "case_insensitive", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "si", kwlist, &value,
                                     &case_insensitive)) {
        return NULL;
    }
...
static PyObject* record_contains_field(record* self, PyObject* args,
                                       PyObject* kwds) {
    const char* field_name = NULL;
    const char* field_value = NULL;
    static char* kwlist[] = {"field_name", "field_value", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "ss", kwlist, &field_name,
                                     &field_value)) {
        return NULL;
    }
    bool success =
        rec_record_contains_field(self->rcd, field_name, field_value);
    return Py_BuildValue("i", success);
}
...
static PyMethodDef record_methods[] = {
    ...
    {"contains_field", (PyCFunction) record_contains_field, METH_VARARGS,
     "Determine whether a record contains a field whose name is FIELD_NAME and "
     "value FIELD_VALUE."},
    {NULL}};
...
static PyObject* sex_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    bool case_insensitive;
    sex* self;
...
static void sex_dealloc(sex* self) {
...
static PyObject* sex_pycompile(sex* self, PyObject* args, PyObject* kwds) {
    const char* expr;
...
static PyObject* sex_pyeval(sex* self, PyObject* args, PyObject* kwds) {
    bool status;
    record* rec;
    bool success;
    static char* kwlist[] = {"rec", "status", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "Oi", kwlist, &rec, &status)) {
        return NULL;
    }
...
static PyObject* sex_eval_str(sex* self, PyObject* args, PyObject* kwds) {
    record* rec;
    char* str;
...
static PyMethodDef sex_methods[] = {
    ...
    {"pyeval", (PyCFunction) sex_pyeval, METH_VARARGS,
     "Apply a sex expression to a record, setting STATUS to true if it matches "
     "and false otherwise."},
...
static PyObject* fex_new(PyTypeObject* type, PyObject* args, PyObject* kwds) {
    fex* self;
    const char* str;
...
static void fex_dealloc(fex* self) {
...
static PyObject* fex_size(fex* self) {
    int num;
...
static PyObject* fex_member_p(fex* self, PyObject* args, PyObject* kwds) {
    const char* fname;
    int min, max;
    bool success;
    static char* kwlist[] = {"fname", "min", "max", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "zii", kwlist, &fname, &min,
                                     &max)) {
        return NULL;
    }
...
static PyObject* fex_get(fex* self, PyObject* args, PyObject* kwds) {
    size_t position;
...
static PyObject* fex_append(fex* self, PyObject* args, PyObject* kwds) {
    const char* fname;
    int min, max;
    fexelem* tmp = PyObject_NEW(fexelem, &fexelemType);
    rec_fex_elem_t fexel;
...
static PyObject* fex_all_calls_p(fex* self) {
    bool success;
...
static PyObject* fex_check(fex* self, PyObject* args, PyObject* kwds) {
    const char* str;
    enum rec_fex_kind_e kind;
    bool success;
    static char* kwlist[] = {"str", "kind", NULL};
...
static PyObject* fex_sort(fex* self) {
...
static PyObject* fex_str(fex* self, PyObject* args, PyObject* kwds) {
    enum rec_fex_kind_e kind;
    char* str;
...
static PyMethodDef fex_methods[] = {
    ...
    {"check", (PyCFunction) fex_check, METH_VARARGS,
     "Check whether a given string STR contains a proper fex description of "
     "type KIND."},
...
static PyObject* recutils_field_equal_p(PyObject* self, PyObject* args,
                                        PyObject* kwds) {
    field* field1;
    field* field2;
    bool success;
    static char* kwlist[] = {"field1", "field2", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "OO", kwlist, &field1,
                                     &field2)) {
        return NULL;
    }
...
static PyObject* field_name(field* self) {
    const char* str;
...
static PyObject* field_value(field* self) {
    const char* str;
...
static PyObject* field_set_name(field* self, PyObject* args, PyObject* kwds) {
    const char* name;
...
static PyObject* field_set_value(field* self, PyObject* args, PyObject* kwds) {
    const char* value;
...
static PyObject* field_source(field* self) {
    const char* str;
...
static PyObject* field_set_source(field* self, PyObject* args, PyObject* kwds) {
    const char* source;
...
static PyObject* field_location(field* self) {
    size_t loc;
...
static PyObject* field_location_str(field* self) {
    const char* str;
...
static PyObject* field_char_location(field* self) {
    size_t char_loc;
...
static PyObject* field_char_location_str(field* self) {
    const char* char_loc;
...
static PyMethodDef field_methods[] = {
    ...
    {"location_str", (PyCFunction) field_location_str, METH_NOARGS,
     "Return the textual representation of the location of the field within "
     "its source."},
    {"char_location", (PyCFunction) field_char_location, METH_NOARGS,
     "Return an integer representing the char location of the field within its "
     "source. "},
...
static PyObject* comment_new(PyTypeObject* type, PyObject* args,
                             PyObject* kwds) {
    comment* self;
    char* text;
...
static void comment_dealloc(comment* self) {
...
static PyObject* comment_text(comment* self) {
    char* str;
...
static PyObject* comment_set_text(comment* self, PyObject* args,
                                  PyObject* kwds) {
    char* text;
    static char* kwlist[] = {"text", NULL};
...
static PyObject* recutils_comment_equal_p(PyObject* self, PyObject* args,
                                          PyObject* kwds) {
    comment* comment1;
    comment* comment2;
    bool success;
    static char* kwlist[] = {"comment1", "comment2", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "OO", kwlist, &comment1,
                                     &comment2)) {
        return NULL;
    }
...
/*record doc string */
static char comment_doc[] = "A comment is a block of text.";
...
static PyObject* buffer_new(PyTypeObject* type, PyObject* args,
                            PyObject* kwds) {
    buffer* self;
    char** data;
    size_t* size;
...
/*record doc string */
static char buffer_doc[] = "A flexible buffer is a buffer to which stream-like "
                           "operations can be applied.";

static PyMethodDef buffer_methods[] = {{NULL}};
...
PyMODINIT_FUNC initrecutils(void) {
    PyObject* m;
